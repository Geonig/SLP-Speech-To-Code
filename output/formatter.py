...
class formatter:
    def __init__ (self,statements):
       self.write_statements(self.format_statements(statements))
    ...
    def format_statements(self,statements):    
        ...
        for stmt, args in zip(b_s, var_nums):
            ...
            statements[pos] = self.format_params(statements[pos:(pos + args + 1)])
    ...
    def format_params(self,statements):
