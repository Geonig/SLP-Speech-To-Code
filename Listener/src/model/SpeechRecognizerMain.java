...
/* @author Andreas (my contributions are mostly in the .gram file)
 * 99 percent of this code is taken from: https://www.youtube.com/watch?v=R8vsXKFTee0
 */
...
import javax.sound.sampled.AudioSystem;			//for Mircophone
...
public class SpeechRecognizerMain {
	...
	/**
	 * This variable is used to ignore the results of speech recognition because it actually can't be stopped...
	 * 
	 * <br>
	...
	/** Checks if the speech recognizer is already running */
	...
	/** This executor service is used for the playerState events to be executed in an order */
	...
	public SpeechRecognizerMain() {
		...
		//TODO: AM: These 2 lines should be thrown out 
	...
	/** Makes a decision based on the given result @param speechWords */
